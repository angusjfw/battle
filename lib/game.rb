...
class Game
  include Attack
  attr_reader :player1, :player2, :ai, :hard,  :turns, :damage, :prev_damage, 
    :move, :prev_move, :loser

  def initialize(player1, player2, ai, hard)
    @player1, @player2, @ai, @hard = player1, player2, ai, hard
